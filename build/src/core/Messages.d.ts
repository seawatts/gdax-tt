...
export declare function isStreamMessage(msg: any): boolean;
export interface ErrorMessage extends StreamMessage {
    type: 'error';
    message: string;
    details?: any;
}
export declare function isErrorMessage(msg: any): boolean;
/**
...
export declare function isUnknownMessage(msg: any): boolean;
/**
...
export declare function isOrderbookMessage(msg: any): boolean;
/**
...
export declare function isOrderMessage(msg: any): boolean;
/**
